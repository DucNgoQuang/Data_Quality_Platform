...
EXTRA_CATEGORICAL_COLOR_SCHEMES = [
    {
        "id": "dq_dashboard_colors",
        "description": "Custom colors for Data Quality dashboard",
        "label": "Data Quality Colors",
        "isDefault": True,
        "colors": [
            "#009688",  # Correct (green-cyan)
            "#FFEB3B",  # Warning (yellow)
            "#FF9800",  # Error (orange)
            "#F44336",  # Fatal (red)
            "#2196F3",  # Extra blue (optional for future)
            "#4CAF50",  # Alternate green
            "#E91E63",  # Pink (optional, for more categories)
        ]
    }
]
