...
then
  ...
  --jars /opt/spark/jars/hadoop-aws-3.3.4.jar,/opt/spark/jars/aws-java-sdk-bundle-1.12.262.jar,/opt/spark/jars/delta-spark_2.12-3.3.1.jar,/opt/spark/jars/delta-storage-3.3.1.jar \
